...
public class BFSTemplate {
    private void bfs(List<Node> graphNode) {
        ...
        // -- Step 1. init the queue for BFS and hashset for visited node checking
    ...
    // use for adding in-degree of the DAG (for un-directed graph, no need to calculate in-degree)
